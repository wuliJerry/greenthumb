...
(send search superoptimize encoded-code (send printer encode-live '#(#(#f #f #f #f) #f)) "alternatives-all/rem/0/driver-1" 120 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
