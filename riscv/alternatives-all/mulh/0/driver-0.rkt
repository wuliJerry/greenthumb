...
(send search superoptimize encoded-code (send printer encode-live '#(#(#f #f #f #f) #f)) "alternatives-all/mulh/0/driver-0" 120 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
