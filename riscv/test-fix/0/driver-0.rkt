...
(send search superoptimize encoded-code (send printer encode-live '#(#(#f #f #f #f) #f)) "test-fix/0/driver-0" 15 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
