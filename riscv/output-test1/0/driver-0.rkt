...
(send search superoptimize encoded-code (send printer encode-live '(0)) "output-test1/0/driver-0" 5 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
