...
(define search (new riscv-symbolic% [machine machine] [printer printer] [parser parser] [validator validator] [simulator simulator-rosette] [syn-mode `partial2]))
...
(send search superoptimize encoded-code (send printer encode-live '(0)) "output-test3/0/driver-0" 10 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
