...
(send search superoptimize encoded-code (send printer encode-live '(2)) "output/0/driver-0" 30 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
