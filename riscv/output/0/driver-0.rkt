...
(send search superoptimize encoded-code (send printer encode-live '(5)) "output/0/driver-0" 3600 #f #:assume #f #:input-file #f #:start-prog #f #:prefix encoded-prefix #:postfix encoded-postfix)
